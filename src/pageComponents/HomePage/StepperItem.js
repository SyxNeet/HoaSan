  ...
  return (
    <div className={`${className} num-item absolute flex flex-col justify-center items-center`}>
        <div className='relative'>
            ...
            <div className='absolute inset-0 num_absolute'></div>
        </div>
        <p className='text-center title-num line-clamp-2 md:text-[1.5rem] text-textPrimary font-[800] leading-[125%] tracking-[-0.075rem] md:w-[12rem]'>
            {title}
        </p>
    </div>
  )
